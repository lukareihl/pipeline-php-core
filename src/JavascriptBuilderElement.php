...
/**
 * The JavascriptBuilderElement aggregates JavaScript properties
 ...
 * The JavascriptBuilderElement is constructed with a url for this endpoint.
 */
class JavascriptBuilderElement extends FlowElement
{
    ...
    /**
     * The JavascriptBuilderElement captures query string evidence and
