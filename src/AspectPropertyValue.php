...
class AspectPropertyValue
{
     ...
     *
     * @param null|string $noValueMessage if there is no value, the reason for there not being one
     * @param string|array<mixed> $value the value
     */
